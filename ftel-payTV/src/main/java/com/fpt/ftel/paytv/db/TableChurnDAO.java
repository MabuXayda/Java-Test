...
public class TableChurnDAO {
	private static final String SQL_CREATE_TABLE_CHURN_DAILY = "CREATE TABLE IF NOT EXISTS churn_daily (contract VARCHAR(22), customer_id VARCHAR(22), date DATE, "
	...
	private static final String SQL_CREATE_TABLE_CHURN_PROFILE_SUM = "CREATE TABLE IF NOT EXISTS churn_profile_sum (contract VARCHAR(22), customer_id VARCHAR(22), "
			+ "h_00 INT, h_01 INT, h_02 INT, h_03 INT, h_04 INT, h_05 INT, h_06 INT, h_07 INT, h_08 INT, h_09 INT, "
			+ "h_10 INT, h_11 INT, h_12 INT, h_13 INT, h_14 INT, h_15 INT, h_16 INT, h_17 INT, h_18 INT, h_19 INT, "
			+ "h_20 INT, h_21 INT, h_22 INT, h_23 INT, "
			+ "a_iptv INT, a_vod INT, a_sport INT, a_child INT, a_relax INT, a_service INT, a_bhd INT, a_fims INT, "
	...
	private static final String SQL_CREATE_TABLE_CHURN_PROFILE_WEEK = "CREATE TABLE IF NOT EXISTS churn_profile_week (contract VARCHAR(22), customer_id VARCHAR(22), week VARCHAR(10), "
			+ "h_00 INT, h_01 INT, h_02 INT, h_03 INT, h_04 INT, h_05 INT, h_06 INT, h_07 INT, h_08 INT, h_09 INT, "
			+ "h_10 INT, h_11 INT, h_12 INT, h_13 INT, h_14 INT, h_15 INT, h_16 INT, h_17 INT, h_18 INT, h_19 INT, "
			+ "h_20 INT, h_21 INT, h_22 INT, h_23 INT, "
			+ "a_iptv INT, a_vod INT, a_sport INT, a_child INT, a_relax INT, a_service INT, a_bhd INT, a_fims INT, "
	...
	private static final String SQL_CREATE_TABLE_CHURN_PROFILE_MONTH = "CREATE TABLE IF NOT EXISTS churn_profile_month (contract VARCHAR(22), customer_id VARCHAR(22), month VARCHAR(10), "
			+ "h_00 INT, h_01 INT, h_02 INT, h_03 INT, h_04 INT, h_05 INT, h_06 INT, h_07 INT, h_08 INT, h_09 INT, "
			+ "h_10 INT, h_11 INT, h_12 INT, h_13 INT, h_14 INT, h_15 INT, h_16 INT, h_17 INT, h_18 INT, h_19 INT, "
			+ "h_20 INT, h_21 INT, h_22 INT, h_23 INT, "
			+ "a_iptv INT, a_vod INT, a_sport INT, a_child INT, a_relax INT, a_service INT, a_bhd INT, a_fims INT, "
	...
	public void createTable(Connection connection) throws SQLException {
		...
		System.out.println(SQL_CREATE_TABLE_CHURN_PROFILE_SUM);
		PostgreSQL.executeUpdateSQL(connection, SQL_CREATE_TABLE_CHURN_PROFILE_SUM);
		System.out.println(SQL_CREATE_TABLE_CHURN_PROFILE_WEEK);
		PostgreSQL.executeUpdateSQL(connection, SQL_CREATE_TABLE_CHURN_PROFILE_WEEK);
		System.out.println(SQL_CREATE_TABLE_CHURN_PROFILE_MONTH);
